...
const myContent = [
  {
    ...
    subTitle: 'Do you want to feel happy, confident, InStyle and avoid wasting money?',
    descriptions: [
  ...
  },
  {
    ...
    finishingText: 'Get to know more details and book your appointment now :)',
    img:
      'http://daman.co.id/daman.co.id/wp-content/uploads/2017/05/18160966_1300500379997093_1978007820502564864_n-1024x1024.jpg',
  },
];
